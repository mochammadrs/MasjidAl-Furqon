    ...
    >
      ...
      >
        <div class="relative">
          ...
          <!-- Button -->
          <div class="relative w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center group-hover:scale-110">
            <svg
          ...
          <!-- Tooltip -->
          <div class="absolute right-full mr-3 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
...
onMounted(() => {
  ...
  // Tampilkan button setelah delay singkat
  setTimeout(() => {
    show.value = true
  }, 1000)
})
